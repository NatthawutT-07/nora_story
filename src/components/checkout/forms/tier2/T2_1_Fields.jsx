...
/**
 * T2-1 Standard Love — Form Fields (standalone, not shared with T1-1)
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 mb-2 pb-2 border-b border-gray-100">
                <span className="text-xs font-bold px-2 py-0.5 rounded bg-teal-100 text-teal-600">
                    Tier 2-1
                </span>
                <span className="text-xs text-gray-400">Standard Love</span>
            </div>
