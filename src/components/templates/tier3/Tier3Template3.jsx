...
const MusicPlayer = ({ musicUrl }) => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50">
            ...
            <button
                onClick={togglePlay}
                className={`w-11 h-11 rounded-full flex items-center justify-center backdrop-blur-md border border-rose-200/30 shadow-lg transition-all duration-300 ${isPlaying ? 'bg-rose-500/20 text-rose-300 animate-spin-slow' : 'bg-white/5 text-rose-200/50'}`}
            >
